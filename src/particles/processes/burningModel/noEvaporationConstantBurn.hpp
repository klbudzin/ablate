#ifndef ABLATELIBRARY_NOEVAPORATIONCONSTANTBURN_HPP
#define ABLATELIBRARY_NOEVAPORATIONCONSTANTBURN_HPP
...
class NoEvaporationConstantBurn : public ablate::particles::processes::BurningProcess
{
    public:
        ...
        NoEvaporationConstantBurn(PetscReal convectionCoeff, PetscReal ignitionTemperature, PetscReal burnRate, PetscReal nuOx,
...
#endif //ABLATELIBRARY_NOEVAPORATIONCONSTANTBURN_HPP
