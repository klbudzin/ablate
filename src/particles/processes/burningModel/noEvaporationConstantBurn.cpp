#include "noEvaporationConstantBurn.hpp"
#include "utilities/constants.hpp"

ablate::particles::processes::burningModel::NoEvaporationConstantBurn::NoEvaporationConstantBurn(PetscReal convectionCoeff,
...
REGISTER(ablate::particles::processes::Process, ablate::particles::processes::burningModel::NoEvaporationConstantBurn, "Example of an no evaporation/Burning Model",
