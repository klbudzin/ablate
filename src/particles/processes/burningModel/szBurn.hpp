...
//    std::shared_ptr<eos::zerorkEOS> eos;
    ...
    private:
        ...
        std::vector<std::string> speciesNames{"","O2", "N2", "CO2", "H2O"};
        std::vector<PetscInt> speciesOffSet{-1,-1,-1,-1,-1};
        ...
        void BisectionMethodSolve(std::function<double(double)> func, double a, double b, double tol, int maxIter);
        ...
        */
        ...
        void UpdateParticleBurning(accessors::EulerianAccessor& eA, accessors::MutableSwarmAccessor& mA) override {
           ...
           //Checking if the Particle Temperature is above the ignition temperature
